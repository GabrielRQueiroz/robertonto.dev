...
const Portfolio = () => {
	...
	return (
		<PortfolioSection>
			<PortfolioSlider tabIndex={11} onFocus={accessiblyGoToNextView} plugins={_sliderPlugins} circular={true} horizontal={false} preventClickOnDrag={true} moveType={['strict', { count: 1 }]}>
